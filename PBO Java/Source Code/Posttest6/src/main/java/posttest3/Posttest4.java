...
public class Posttest4 {
    ...
    public final String cabang = "Samarinda";

    public final void show(Pegawai[] pg, String cabang){
        System.out.println("Cabang ekspedisi: " + cabang + "\n");
        for(int i = 0; i < pg.length; i++){
            System.out.println("ID pegawai: " + pg[i].getIdPegawai());
            System.out.println("Nama pegawai: " + pg[i].getNamaPegawai());
            System.out.println("Umur pegawai: " + pg[i].getUmurPegawai());
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        Pegawai[] pgw = {
            new KurirA(0, 45, "Abdul")
        };

        Posttest4 abc = new Posttest4();
        abc.show(pgw, abc.cabang);
